...
function Fold:get_lines()
  return vim.api.nvim_buf_get_lines(self.buffer, self.start - 1, self.end_line - 1, false)
end
...
function Fold:__tostring()
  return self:get_line(0) or ""
end

-- Get foldlevel at a given line number
function M.get_foldlevel_at(lineno)
