-- Unit tests for sort-folds plugin
-- These tests verify that folds can be sorted correctly
...
describe("sort-folds", function()
  ...
  describe("custom key functions", function()
    ...
    it("should use built-in get_citekey function", function()
      ...
      local result = vim.api.nvim_buf_get_lines(0, 0, -1, false)
      assert.is_true(result[1]:match("adams2021") ~= nil)
      assert.is_true(result[4]:match("jones2019") ~= nil)
      assert.is_true(result[7]:match("smith2020") ~= nil)
  ...
  describe("edge cases", function()
    ...
    it("should handle empty buffer", function()
      ...
      local ok = pcall(function()
        sort_folds.sort_folds_range(1, 1, 0)
      end)
      assert.is_true(ok)
    end)
